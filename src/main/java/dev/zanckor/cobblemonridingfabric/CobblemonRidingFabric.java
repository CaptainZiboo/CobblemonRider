...
public class CobblemonRidingFabric implements ModInitializer {
        ...
        public static void addConfigChunk(int index, String chunk, int total) {
                ...
                if (chunks.size() == totalChunks) {
                        ...
                        LOGGER.info("[RIDE] Rebuilt JSON from chunks: " + fullConfig);
                        ...
                        LOGGER.info("[RIDE] Parsed object: " + pokemonJsonObject);
                        LOGGER.info("[RIDE] Checking Entei: " + pokemonJsonObject.getPokemonData("entei"));
                        LOGGER.info("[RIDE] Offsets: " + pokemonJsonObject.getPokemonData("entei").getRidingOffset());
                        LOGGER.info("[RIDE] Base offset: "
                                        + pokemonJsonObject.getPokemonData("entei").getRidingOffset().getDefault());
        ...
        private void registerEvents() {
                ...
                LOGGER.info("[RIDE] Loaded ride config", config);
        ...
        public static void serverFolderManager(MinecraftServer server) {
                ...
                pokemonJsonObject.add("Charizard",
                                new PokemonJsonObject.PokemonConfigData(
                                                ...
                                                new PokemonJsonObject.OffsetData(
                ...
                try {
                        ...
                        CobblemonRidingFabric.pokemonJsonObject = new Gson().fromJson(pokemonRideConfigObject,
                                        PokemonJsonObject.class);
                } catch (IOException ex) {
